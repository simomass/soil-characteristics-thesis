...
area Mediterranea. ] % [] is optional - is placed on the bottom of the
...
\includemedia[
  ...
  activate=pageopen,
  addresource=/home/simone/Simo_GIT/foto/PoreSize.mp4,
  flashvars={source=/home/simone/Simo_GIT/foto/PoreSize.mp4}
]{}{VPlayer.swf}
\end{frame}
...
\begin{frame}{Sintesi finale}
  ...
  \item densità apparente:
    \begin{itemize}
    \item metodo \emph{Core}, nonostante la semplicità esecutiva,
      sembra inadeguato a cogliere differenze di qualsiasi genere
      (\emph{anno, lavorazione, conduzione}).

    \item metodo \emph{Clod} mostra differenze significative, ma di
      una entità tale da non risultare tecnologicamente rilevanti.
    \end{itemize}
  \item distribuzione dinamica: riscontrata una
  ...
  \item porosimetria: mostra una tendenza da parte dei suoli
