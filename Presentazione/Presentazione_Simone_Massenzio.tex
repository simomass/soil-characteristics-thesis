...
Girasole (t/ha) & 3.52$\pm$0.18 &2.32$\pm$0.02 & 0.25$\pm$0.07 &  1.18$\pm$0.09 \\ 
   \hline
\end{tabular}
}
\end{table}
...
\begin{frame}{Parte 2 \small{Metodi di analisi}}
  \begin{columns}[c]
    ...
    \only<8>{\animategraphics[loop,autoplay,width=\linewidth]{12}{../foto/poresize/PoreSize-}{0}{396}}%%396
    % \end{overlayarea}
  \end{columns}
\end{frame}
...
\begin{frame}{Parte 3 \small{Stabilità degli aggregati}}
  ...
  \only<2>{%%\begin{overlayarea}{\linewidth}{3cm}
    \begin{figure}
      \centering
      \includegraphics[width=0.5\textwidth]{../grafici/boh.jpeg}
    \end{figure}}
  \only<3>{%%\begin{overlayarea}{\linewidth}{3cm}
    \begin{figure}
      \centering
  ...
  \only<4>{
    \begin{figure}
      \centering
      \includegraphics[width=0.5\textwidth, page=1]{../grafici/puntostabilita.pdf}
...
\begin{frame}[label=distribuzione]{Parte 3 \small{Stabilità degli aggregati}}
  ...
  \only<1>{\begin{figure}
      \includegraphics[width=0.75\textwidth, page=2]{../grafici/stabilita.pdf}
    \end{figure}}
  \only<2>{  \begin{figure}
      \includegraphics[width=0.75\textwidth, page=3]{../grafici/stabilita.pdf}
    \end{figure}}
  \only<3>{  \begin{figure}
      \includegraphics[width=0.75\textwidth, page=4]{../grafici/stabilita.pdf}
    \end{figure}}
  \only<4>{  \begin{figure}
      \includegraphics[width=0.75\textwidth, page=5]{../grafici/stabilita.pdf}
    \end{figure}}
  \only<5>{  \begin{figure}
      \includegraphics[width=0.75\textwidth, page=6]{../grafici/stabilita.pdf}
    \end{figure}}
  \only<6>{  \begin{figure}
      \includegraphics[width=0.75\textwidth, page=7]{../grafici/stabilita.pdf}
    \end{figure}}
  \only<7>{  \begin{figure}
      \includegraphics[width=0.75\textwidth, page=8]{../grafici/stabilita.pdf}
    \end{figure}}
  \only<8>{  \begin{figure}
      \includegraphics[width=0.75\textwidth, page=9]{../grafici/stabilita.pdf}
    \end{figure}}
\end{frame}
...
\begin{frame}<presentation:0>
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.2\textwidth, page=3]{../grafici/RisultatiChimica-Fisica.pdf}
  \end{figure}
\end{frame}
