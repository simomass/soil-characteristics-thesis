...
df.data$PESI <- read.table("~/Simo_GIT/dati_elaborati/pesoaggre.csv", sep = ";")$x
...
@
\caption[didascalia corta]{Diagramma ternario della distribuzione dei pori. Gli apici del triangolo rappresentano le classi dimensionali in cui le particelle sono divise in: maggiori
  di \Sexpr{vec.paletti.poro[1]} (macropori), comprese tra
  \Sexpr{vec.paletti.poro[1]} e \Sexpr{vec.paletti.poro[2]} (mesopori) e inferiori a
  \Sexpr{vec.paletti.poro[2]} \SI{}{\micro\metre} (micropori)}
