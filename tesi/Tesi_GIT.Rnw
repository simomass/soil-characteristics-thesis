...
Nel terreno è importante la distribuzione granulometrica,
...
\ref{fig:foto_CO_sito}): m (medio), a (alto, 4
...
names(summary.campo) <-
    c("Anno", "Conduzione", "Lavorazione", "Media", "Dev. std", "n")
summary.campo$Anno <-
...
\emph{Conduzione} sono statisticamente significative.
...
\info[inline]{Questa roba, corretta va messa nel capitolo discussione}
...
tabella.petrolio <-
    xtable(summary.petrolio,
           label = 'tab:summaryClod', align  = "lllccc",
           caption =
