...
\dubbio{Simo guardare qui per i domains, non chiarissimo
  \url{http://tinyurl.com/yd6b3geg}} e gli aggregati.
...
Le misure della distribuzione dei pori sono state realizzate con
porosimetro Carlo Erba serie 2000 collegato ad un elaboratore DOS per
la raccolta e la elaborazione dei dati.

Il porosimetro \`e corredato di una unit\`a macropore per la misura
dei macropori nell'intervallo compreso da circa \SI{15}{\micro\meter}
e circa \SI{2000}{\micro\meter} di diametro, anch'essa connessa con il calcolatore.

L'intrusione di mercurio tra \SI{0}{\atm} e \SI{1}{\atm} \`e
realizzato con l'unit\`a macropore, da \SI{1}{atm} a \SI{2000}{atm}
mediante il Porosimetro serie 2000.
...
riempimento del capillare, nell'autoclave del Porosimetro 2000. Una
...
La progressiva penetrazione di mercurio nel campione \`e seguita
elettricamente, infatti il mercurio all'interno del capillare
costituisce una delle armature di un condensatore (l'altra \`e
solidale con la chiusura dell'autoclave) la cui capacit\`a varia al
diminuire di mercurio nel capillare. Il segnale elettrico che ne
deriva viene convertito in volume di mercurio intruso sull'unit\`a di
controllo. Il calcolo della distribuzione dei pori, mediante
l'equazione di Washburn, viene effettuata dopo la sottrazione
...
\migliora{8rino Rimane da giustificare i 5 campioni del 2015}
...
slacking. Risulta che gli aggregati provenienti da appezzamenti
...
facciano gli aggregati "biologici". E questo avviene sia con aggregati
umidi che secchi.
...
\item Densità
  ...
  \end{itemize}
\item Penetrometria \info[inline]{8rino Già troppa roba non ce la metterei} 
...
\begin{figure}[ht]
  ...
  2000]{Rappresentazione del funzionamento del Mastersizer 2000 presa
    da:
    \href{https://plus.google.com/communities/110676150876604729660/stream/ffa7f40a-1c65-4268-9121-bb88d63f0c41}{questo
      sito}}
...
\chapter{Funzionamento porosimetro ad intrusione di mercurio}
